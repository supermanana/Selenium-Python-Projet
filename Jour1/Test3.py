...
# spécifier le chemin ou se trouver le driver
#service_obj = Service("D:\\SQL\\session 3\\Automatisation des tests I\\chromedriver_win32\\chromedriver.exe")
# 1) Ouvrir le navigateur(chrome/firefox/Edge) // créer un objet de type chrome qui va contrôler notre application
# driver = webdriver.Chrome(service=service_obj)
# 2) Naviguer vers l'url https://opensource-demo.orangehrmlive.com/
driver = webdriver.Chrome()  # constructeur, une sorte de raccourci, pas besoin de spécifier le chemin
